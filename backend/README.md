...
## Project Structure
    ...
    ├── testapiautoteammemb_70860  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_70860`
...
2. Clone this repo and `cd testapiautoteammemb_70860`
